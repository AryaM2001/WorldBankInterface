...
/**
 * Class for viewer Times Series method
 * @author Jasmine C., Darshil Choksi, Arya Mattu, Zane Chiang
 *
 */
public class TimeSeriesViewer implements Viewer{
	public JPanel west;
	...
	/**
	 * Constructor for TimeSeriesViewer which creates the Times Series Viewer for panel
	 * @param _west JPanel for the JFrame
	 * @param _analy Analysis object 
	 */
	public TimeSeriesViewer(JPanel _west, Analysis _analy) {
		west = _west;
