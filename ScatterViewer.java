...
/**
 * Class for viewer Scatter Viewer 
 * @author Jasmine C., Darshil Choksi, Arya Mattu, Zane Chiang
 *
 */
public class ScatterViewer implements Viewer{
	public JPanel west;
	...
	/**
	 * Constructor for ScatterViewer which creates the Scatter Viewer for panel
	 * @param _west JPanel for the JFrame
	 * @param _analy Analysis object 
	 * @param selChoices Selection object
	 */
	public ScatterViewer(JPanel _west, Analysis _analy, Selection selChoices) {
		west = _west;

		analy = _analy;
		TimeSeries series1 = new TimeSeries(selChoices.getAnalysis());
		...
		TimeSeries series2 = new TimeSeries(selChoices.getAnalysis());
		...
		TimeSeries series3 = new TimeSeries(selChoices.getAnalysis());
		...
		JFreeChart scatterChart = new JFreeChart(selChoices.getAnalysis(),
